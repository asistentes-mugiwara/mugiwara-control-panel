...
CREW_CARDS: tuple[MugiwaraCard, ...] = (
    MugiwaraCard(
        ...
        'Luffy',
        'operativo',
        'Coordina prioridades, reparte trabajo entre especialistas y cierra decisiones ejecutivas.',
        ['delegation-contract', 'crew-orchestration'],
        'Capitán operativo',
        _crew_links('luffy'),
    ),
    MugiwaraCard(
        ...
        'Zoro',
        'operativo',
        'Diseña, implementa y valida software: arquitectura, PRs, testing y calidad técnica.',
        ['sdd-orchestrator-zoro', 'zoro-pr-review-handoff'],
        'Continuidad fuerte',
        _crew_links('zoro'),
    ),
    MugiwaraCard(
        ...
        'Franky',
        'operativo',
        'Opera infraestructura, servicios, automatizaciones, backups y salud del runtime.',
        ['franky-pr-ops-review', 'vault-sync-ops'],
        'Runtime vigilado',
        _crew_links('franky'),
    ),
    MugiwaraCard(
        ...
        'Chopper',
        'operativo',
        'Vigila seguridad, permisos, secretos, dependencias y exposición accidental.',
        ['chopper-pr-security-review', 'security-hardening'],
        'Riesgo controlado',
        _crew_links('chopper'),
    ),
    MugiwaraCard(
    ...
    MugiwaraCard(
        ...
        'Nami',
        'operativo',
        'Ordena finanzas, hojas de cálculo, métricas económicas y control operativo.',
        ['finance-ops', 'google-sheets-control'],
        'Señales estables',
        _crew_links('nami'),
    ),
    MugiwaraCard(
        ...
        'Robin',
        'operativo',
        'Investiga, sintetiza contexto, mantiene canon y separa memoria útil de ruido.',
        ['research-synthesis', 'vault-canon'],
        'Canon consultable',
        _crew_links('robin'),
    ),
    MugiwaraCard(
