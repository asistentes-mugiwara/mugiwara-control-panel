...
mustInclude(producer, 'MAX_CRON_REGISTRY_BYTES = 1_048_576', 'cronjobs status producer')
mustInclude(producer, 'def _ensure_registry_size_is_safe(registry_path: Path) -> None:', 'cronjobs status producer')
mustInclude(producer, "raise CronjobsStatusProducerError('cron registry exceeds safe size limit')", 'cronjobs status producer')
