...
mustInclude(perimeterDoc, 'Phase 14.1 implements the safe foundation slice:', 'security perimeter document')
mustInclude(perimeterDoc, 'Healthcheck latest-update aggregation parses timestamps explicitly instead of using lexical string ordering', 'security perimeter document')
mustInclude(perimeterDoc, 'Dashboard aggregation honors sanitized record severity, including deterministic `critical` values', 'security perimeter document')
mustInclude(perimeterDoc, 'do not turn Healthcheck into a generic host console', 'security perimeter document')
